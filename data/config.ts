...
export const projects: Project[] = [
  {
    id: 1,
    title: 'TuneQuest',
    subtitle: 'AI-Powered Music Education Platform',
    description:
      'An adaptive music education platform that uses Google Gemini AI to personalise lesson paths for each learner. Features JWT authentication, PayPal subscription billing, AWS S3 media storage, and a split-settings deployment pipeline.',
    tags: ['Django', 'AI', 'Python', 'Gemini', 'AWS', 'PayPal'],
    features: [
      'Google Gemini AI integration for adaptive lesson generation',
      'JWT authentication with refresh-token rotation',
      'PayPal subscription billing with webhook handling',
      'AWS S3 media storage for audio and sheet music assets',
      'Split settings architecture (base / local / production)',
      'Lesson progress tracking and spaced-repetition engine',
      'Interactive quiz and ear-training modules',
      'Admin dashboard for content and user management',
    ],
    deliverables: [
      'Production-ready Django REST API with full test coverage',
      'AI lesson pipeline powered by Gemini',
      'Subscription management with PayPal SDK',
      'AWS S3 media CDN integration',
    ...
    techIcons: [
      ...
      { icon: 'logos:google-icon',   label: 'Gemini AI' },
      { icon: 'logos:aws',           label: 'AWS S3'    },
    ...
    github: 'https://github.com/mielle-almedejar/tunequest',
    featured: true,
    status: 'in-progress',
