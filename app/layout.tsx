...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Mielle Almedejar",
    description: "Your Freelancer Buddy!",
    url: "https://mielle.tech",
    siteName: "Mielle",
    images: [
      {
        url: "https://mielle.tech/og-image.png",
        width: 1200,
        height: 630,
        alt: "Mielle preview",
      },
...
export default function RootLayout({
  ...
  return (
    <html
      ...
      className={`${spaceGrotesk.variable} ${sora.variable} ${firaCode.variable}`}
    >
