          ...
          <div className="grid lg:grid-cols-[1fr_1.4fr] gap-10 items-start">
            ...
            <motion.div variants={fadeUp} className="space-y-6">
              <p className="text-muted-foreground leading-relaxed">
                I&apos;m open to freelance, full-time, and collaborative
                projects. Fill out the form — or reach me directly below.
              </p>
              ...
              <MagneticButton href={siteConfig.resumeUrl} download>
                <Button variant="outline" className="w-full gap-2 my-2">
